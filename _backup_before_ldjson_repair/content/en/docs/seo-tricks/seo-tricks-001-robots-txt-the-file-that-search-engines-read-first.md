...
title: "001 Robots.txt â€“ The File That Search Engines Read First | SEO Tricks"
...
tags: [robots.txt, technical SEO, crawling, crawl budget, sitemap, Hugo, website verification]
...
categories: [SEO Tricks, Technical SEO, Crawling]
series: SEOTricks
series_index: 1
...
draft: false
canonical: https://pivtorak.studio/en/docs/seo-tricks/001-robots-txt-the-file-that-search-engines-read-first/
toc: true
weight: 1
completion: 100
seo: true
...
<script type="application/ld+json">
{
  ...
  "@type": "TechArticle",
  "@id": "https://pivtorak.studio/en/docs/seo-tricks/001-robots-txt-the-file-that-search-engines-read-first/#article",
  "headline": "001 Robots.txt â€“ The File That Search Engines Read First | SEO Tricks",
  "description": "A practical technical SEO check of robots.txt: what the file does, why it matters for crawling, and how to verify it from source to generated build to live website.",
  "inLanguage": "en",
  "url": "https://pivtorak.studio/en/docs/seo-tricks/001-robots-txt-the-file-that-search-engines-read-first/",
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://pivtorak.studio/en/docs/seo-tricks/001-robots-txt-the-file-that-search-engines-read-first/"
  },
...
![SEO Tricks. Robots.txt: The File That Search Engines Read First. AP | Pivtorak.Studio. 07.09.2026 Â© Anna Pivtorak (Kostyuk)](/images/seo-tricks-001-robots-txt-the-file-that-search-engines-read-first.webp)
...
**What should we actually expect to find when we open a websiteâ€™s `robots.txt`?**
...
That makes the file part of a websiteâ€™s technical SEO infrastructure. If it is missing, inaccessible, malformed, or contains unintended instructions, crawlers may not receive the directions the site owner intended.

And there is another important lesson:

**Finding a `robots.txt` file is not the end of the check.**

We also need to look at what the file actually contains â€” and, for a generated website, how that content got there in the first place.
...
The local build confirmed that Hugo could generate a `robots.txt` file â€” but the generated file was **not a valid robots.txt for our site**.
...
robots.txt Â· technical SEO Â· crawling Â· crawl budget Â· sitemap

...
- **Family**   
**Husband:** [Anatolii Ivanovych Kostiuk (Aug 26, 1948 – Jun 14, 2015)](https://memoryon.net/s/lijWG7pPh8), married since 1969   
Son: [Oleksandr Anatoliiovych Kostiuk, b. Feb 24, 1971](https://memoryon.net/s/yFqF5I7awO)   
Daughter: [Anna Anatoliivna Pivtoraк (Kostiuk), b. Oct 9, 1976](https://memoryon.net/s/eOKTKuOc9l)   
Grandchildren: six   
...
- Errors are not corrected — they are prevented   
- Clean form creates clarity of thought   
- A text must be written correctly from the start  
- Handwriting reflects inner structure   
- Repetition leads to quality   
- Learning happens through refinement to an ideal state   
...
## 6. Transmitted Sensibilities   

- Beauty is created in the details   
- Neatness is a form of respect   
- Language must sound precise and clear   
- Care is expressed through concrete actions   
- A home is a space that is felt   
- Education is not an obligation, but an inner culture  
- Gentleness and high standards can coexist   
- Silence carries meaning   
- Excellence is the result of discipline, not talent   
- The level of environment determines a person’s trajectory   

## 7. Formative Scenes   

### 📓 1. Perfect Form  
*Form as Thinking*   
A notebook allows no mistakes.    
A text must be written correctly from the start — without corrections or crossings-out.   
Repetition becomes a tool.    
Each new page is more precise than the previous one.   
Form no longer limits —  it creates clarity of thought.   

### 📖 2. Language and Understanding   
*Language as Structure*  
A text is read aloud.    
Intonation, pauses, meaning — everything must align.   
An error is not a sound, but a lack of understanding.   
Understanding develops gradually.    
At some point, reading becomes precise.   
Language stops being form —  it becomes thinking.   

### 🌿 3. Decision and Environment   
*Environment as Choice*  
A decision is not made under the influence of an offer.    
It is made through understanding the environment.   
Behind attractive conditions, there may be a different reality.    
And it must be seen.   
The environment determines development.    
...
The base is always perceived first.  
What highlights must not conceal.  

### 👗 5. Readiness for the meeting  
*Always Ready to Meet*   
Going out is always a possibility of encounter.    
Even if it is just the nearest shop.  
Appearance is not accidental, but a constant readiness.  
Presence has no secondary situations.     

### 🙂 6. Expression as responsibility  
*Facial expression is important*  
The face is part of communication.   
Even in silence.  
Expression is shaped just like words.   
It is not accidental.  
State is read instantly.    

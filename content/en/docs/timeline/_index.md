...
<script type="application/ld+json">
{
  ...
  "name": "Timeline: Path & Evolution — Anna Pivtorak",
  "description": "Automatic reconstruction of events.",
...
**Event Date** — the date the event occurred. **Publication Date** — the date of the record.

...
summary: "De um trabalho concluído por dia para sistemas de investigação interligados: como a observação se tornou design, o design narrativa, a narrativa investigação e a unidade de pensamento evoluiu de obras individuais para programas autónomos de investigação."
...
keywords: [evolução de escala, unidade de pensamento, sistemas criativos, programa de investigação, movimento browniano, pensamento sistémico, observação, design, jornalismo, geração autónoma, backlog, Anna Pivtorak]
categories: [Recalibração do Núcleo, Investigação Independente, Pensamento Sistémico]
...
canonical: https://pivtorak.studio/pt/docs/core-recalibration/018-2026-scale-evolution-from-daily-work-to-research-program/
...
<script type="application/ld+json">
{
  ...
  "description": "Uma investigação sobre a evolução de uma disciplina criativa diária para uma arquitetura autónoma de investigação através da transformação sistémica da unidade de pensamento.",
  "inLanguage": "pt-PT",
  "url": "https://pivtorak.studio/pt/docs/core-recalibration/018-2026-scale-evolution-from-daily-work-to-research-program/",
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://pivtorak.studio/pt/docs/core-recalibration/018-2026-scale-evolution-from-daily-work-to-research-program/"
  },
  "image": [
  ...
  "articleSection": "Recalibração do Núcleo",
  "isPartOf": {
...
Foi assim que nasceu a obra _“Drying Wings”_ (Secando as Asas), integrando-se na série _Momentos de Design (Design Moments)_:
...
Pouco tempo depois, na sequência de uma conversa com o meu marido sobre os significados ocultos por trás de vários códigos digitais e os alinhamentos místicos dos ponteiros do relógio, criei a obra _“Mystical Portal”_ (Portal Místico), que lançou as bases para uma nova grande série — _Crónicas do Alienígena (Alien Chronicles)_:
...
À medida que as ideias começaram a surgir de todos os lados, cada novo pensamento exigia a criação de uma série separada. Por um momento, pareceu que a minha página e o meu espaço de trabalho estavam a descer rapidamente para o caos. Uma tentativa de processar este estado resultou na obra conceptual _“Brownian Motion”_ (Movimento Browniano):

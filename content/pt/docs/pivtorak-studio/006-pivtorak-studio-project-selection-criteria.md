...
description: Critérios de ressonância que definem a entrada dos projetos no processo. Alinhamento de escala, precisão, estrutura e valores.
weight: 6
event_date: 2026-04-30 # Data do evento (formulação dos critérios)

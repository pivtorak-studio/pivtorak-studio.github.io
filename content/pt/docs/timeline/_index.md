...
<script type="application/ld+json">
{
  ...
  "name": "Cronologia: Caminho e Evolução — Anna Pivtorak",
  "description": "Reconstrução automática de eventos.",
...
Esta secção reúne automaticamente todos os eventos do seu percurso.  
